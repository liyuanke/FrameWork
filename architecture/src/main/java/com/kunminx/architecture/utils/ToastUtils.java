...
import com.kunminx.architecture.op.Spannable;
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                SpannableString spannableString = new Spannable(text)
                        .setPosition(0, text.length())
                        .setForegroundColor(messageColor)
                        .setSize(DisplayUtils.dp2px(16))
                        .build();
